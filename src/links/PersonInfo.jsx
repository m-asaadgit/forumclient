...
// function PersonInfo() {
//   const {approvedData}=useContext(ContextAPI)
...
//     //   try {
//     //     const approvedDataResponse = await axios.get(
//     //       "http://localhost:5000/api/auth/approved"
//     //     );
//     //     setapprovedData(approvedDataResponse.data.data);
//     //     // console.log(approvedData);
//     //   } catch (error) {
...
//   return (
//     <div></div>
//     // <div className="bg-white w-[100%] relative px-4 items-center md:pt-[25vh] pt-[15vh] md:px-[2%] md:min-h-[110vh]  min-h-[95vh] flex  flex-col md:flex-row flex-wrap gap-[1%] justify-center py-4">
//     //   {/* <Link
//     //     onClick={() => navigate(-1)}
//     //     className="w-fit px-4 pl-2 flex absolute  top-[5vh] left-[5vw] justify-center items-center font-semibold tracking-wide text-center rounded-sm py-1 text-white h-fit bg-gray-900"
//     //   >
