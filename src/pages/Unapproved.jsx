...
function Unapproved() {
  ...
  return (
    <div className="bg-white w-[100%] md:pt-[34vh] pb-[15vh] md:pb-[15vh] pt-[25vh] relative px-[2%] min-h-[110vh] h-fit flex flex-wrap gap-[1%] justify-center py-4">
      ...
      {filteredData.length === 0 ? (
        <p className="text-black flex items-center justify-center font-extralight">
          No data available of {isChecked ? "male" : "female"}
        </p>
      ) : (
        filteredData.map((item) => (
          <div
            ...
            <div className="w-[42%] h-[200px] flex flex-col b md:gap-0 gap-2 items-center pt-4">
              <div className="w-[80%] md:h-[70%] h-[60%] 0">
                {item.img ? (
                  ...
                  <img
                    src={womenProfile}
                    className="w-full mix-blend-normal bg-slate-300 bg-blend-darken rounded-lg h-full"
                  />
                )}
              </div>
              <Link
