...
function Approved() {
  ...
  return (
    <div className="bg-white w-[100%] relative pb-[15vh]   md:pt-[34vh] pt-[25vh] px-[2%] min-h-[110vh] h-fit flex flex-wrap gap-[1%] justify-center py-4">
      ...
      <Link
        onClick={() => navigate(-1)}
        className="w-fit px-4 pl-2 flex md:hidden fixed  top-[15vh] left-[5vw] justify-center items-center font-semibold tracking-wide text-center rounded-sm py-1 text-white h-fit bg-gray-900"
      >
